...
class Inventory(Sprite):
    ...
    def draw(self, screen: pygame.Surface) -> None:
        ...
        if self.elements["water"] > 0:
            pygame.draw.rect(screen, WATER, pygame.Rect(self.screen_pos.x, self.screen_pos.y, 50, 50))
        ...
        if self.elements["air"] > 0:
            pygame.draw.rect(screen, AIR, pygame.Rect(self.screen_pos.x + 60, self.screen_pos.y, 50, 50))
        ...
        if self.elements["earth"] > 0:
            pygame.draw.rect(screen, EARTH, pygame.Rect(self.screen_pos.x + 120, self.screen_pos.y, 50, 50))
        ...
        if self.elements["fire"] > 0:
            pygame.draw.rect(screen, FIRE, pygame.Rect(self.screen_pos.x + 180, self.screen_pos.y, 50, 50))
