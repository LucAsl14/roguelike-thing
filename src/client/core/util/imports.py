from math import sqrt, sin, cos, tan, asin, acos, atan, atan2, degrees, radians, pi, e, log, log10, exp, ceil, floor, trunc, fmod, modf, pow, hypot, factorial, isnan, isinf, isfinite, copysign, erf, erfc, gamma, lgamma, fsum, gcd, isqrt, comb, perm, prod, inf, nan, tau
